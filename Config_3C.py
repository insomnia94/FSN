...
class Config_3C():
  ...
  # model path
  weight_path = "./weight/model_3C.pkl"
  ...
  #root_image_path = "/home/smj/DataSet/Saliency/DAVIS2017_foreground_train/image"
  #root_label_path = "/home/smj/DataSet/Saliency/DAVIS2017_foreground_train/label"
  ...
  #root_image_path = "/data/smj_data/Saliency/MSRA_TOTAL/image"
  #root_label_path = "/data/smj_data/Saliency/MSRA_TOTAL/label"
  #root_image_path = "/data/smj_data/Saliency/DAVIS2017_foreground_total/image"
  #root_label_path = "/data/smj_data/Saliency/DAVIS2017_foreground_total/label"
  #root_image_path = "/data/smj_data/Saliency/DAVIS2017_foreground_test/image"
  #root_label_path = "/data/smj_data/Saliency/DAVIS2017_foreground_test/label"
  #root_image_path = "/data/smj_data/Saliency/COCO2014_MSRA/image"
  #root_label_path = "/data/smj_data/Saliency/COCO2014_MSRA/label"
